...
export default function Loading(){
    ...
    return (
        ...
        //     <div className="relative flex flex-col border border-purple-500 md:flex md:justify-between ">
        //         {/* head breadcrumble */}
        //         <BreadCrumbs crumbs={[{title:'숙소',link:'/sokso'}]} />

        //         <div className="flex flex-col items-center justify-center border border-green-500">
        ...
        //         </div>
        //     </div>
        // </div> "max-w-[85rem] mx-auto flex flex-col py-14 border border-red-700 mt-20 lg:mt-44 space-y-32"
        <div className="border border-red-700" >
            {/* Header */}
            <StayHeader src={"/images/outside_1.jpeg"} title={"스테이"} subTitle={"고객에게 꼭 맞춘 휴식을 선사합니다."} alt={"stay-header"} />
