...
const StayWrapper = (
    ...
    return( 
        <div className="md:h-[550px] border-0 border-0-green-500" key={`stay`+ wrapperId} >
            <div className="relative border-0 border-0-red-500 w-full h-[200px] md:h-[270px] overflow-hidden group" >
                <div
                    className={` relative transition-transform duration-1000 ease-in-out flex flex-row hover:scale-105 hover:opacity-50 `}
                ...
                {/* left arrow */}
                { index != 0 && images.length > 1 && <div className="hidden cursor-pointer md:group-hover:block md:absolute md:left-0 md:top-1/2 md:-translate-y-1/2" onClick={handlePrev}>
                ...
                {/* right arrow */}
                { index != ( totalSlides - 1 ) && images.length > 1 && <div className="hidden cursor-pointer md:group-hover:block md:absolute md:top-1/2 md:right-0 md:-translate-y-1/2" onClick={handleNext}>
                    <svg width="43" height="43" viewBox="0 0 43 43" fill="none" xmlns="http://www.w3.org/2000/svg">
