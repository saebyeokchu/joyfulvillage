...
// import { CustomTextInput, EditButton } from "@/components/ui";
...
//     const onClickDeleteImage = async (targetSpecial : Cafe, imageName : string | undefined) => {
...
//                             { special.img && special.img.length > 0 && <EditButton csProps="h-10" onClickFunction={()=>onClickDeleteImage(special, special.img)} btnName={"이미지 삭제하기"} /> }
//                         </div>
...
// {/* <div className="border-0 relative" key={`manage_cafe_image_box_2`}>
