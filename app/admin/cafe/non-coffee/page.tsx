...
export default function ManageProgram(){
    ...
    const { data, error, mutate  } = useSWR<Cafe[]>(
        GetCafeDataBySection + CafeSection.noncoffee,
        getFetcher
    );
    ...
    return (
        <>
        <AdminWrapper>
           <CafeWrapper subTitle={"논커피 메뉴 관리하기"} buttons={[{onClickFunction :onClickSaveCoffee, btnName : "저장하기"}]}>
                {undefined}
           </CafeWrapper>
