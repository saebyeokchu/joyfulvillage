...
export default function ManageProgram(){
    ...
    const { data, error, mutate  } = useSWR<Cafe[]>(
        GetCafeDataBySection + CafeSection.dessert,
        getFetcher
    );
    ...
    return (
        <>
        <AdminWrapper>
           <CafeWrapper subTitle={"브런치 & 디저트 메뉴 관리하기"} buttons={[{onClickFunction :onClickSaveCoffee, btnName : "저장하기"}]}>
                {undefined}
           </CafeWrapper>
