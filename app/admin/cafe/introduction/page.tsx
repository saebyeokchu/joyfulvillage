...
export default function CafeIntroduction(){
    ...
    return (
        <>
            <AdminWrapper>
                <CafeWrapper subTitle="카페 도천 소개글" buttons={[{onClickFunction : onClickEditBtn, btnName : "저장하기"}]}>
                    <CustomTextInput inputVal={data[0].content ?? ""} width="w-2/3" textRef={subTitleRef} placeholder={"카페 도천 소개 문구"} csProps={"border-0"} />
                </CafeWrapper>
