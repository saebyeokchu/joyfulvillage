...
import { Get, GetKakao } from "../_api/Biz";
...
export default function Footer(){
    ...
    return(
        <footer className="mt-auto bg-point w-full border-t border-amber-700 border-opacity-15">
            <div className={`mt-auto  py-5 lg:pt-10 ${mobilePx}`}>
                <div className="grid grid-cols-1 gap-6 md:grid-cols-4">
                    ...
                    <div className="col-span-1">
                        ...
                        <div className="text-sm flex flex-col mt-2 md:text-base">
                            <div>{addressText}</div>
                        </div>
                    </div>
                    ...
                    <div className="col-span-1">
                        ...
                        <p className="inline-flex gap-x-2 pt-2">월요일 - 토요일</p>
                        <p className="inline-flex gap-x-2   ">10:00 ~ 18:00</p>
                        <p className="inline-flex gap-x-2 pt-2">일요일 </p>
                        <p className="inline-flex gap-x-2  " >off</p>
                        </div>
                    </div>

                    <div className="col-span-1">
                        사업자 번호 {busniessNumber}
                    </div>


                    <div className="col-span-1 flex flex-row space-x-2">
                        <div className="w-6 h-6">
                            <a className="inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-point-hover focus:outline-none focus:bg-point-darker disabled:opacity-50 disabled:pointer-events-none" href={instaUrl}>
