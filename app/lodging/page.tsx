export default function Loading(){
    return (
        <div className="relative flex flex-col border-t border-t-slate-400 max-w-[85rem] w-full mx-auto md:flex md:justify-between md:gap-3 py-2 px-4 sm:px-6 lg:px-8">
            <nav className="flex gap-x-6">
                <a className="inline-flex items-center gap-x-2 text-sm whitespace-nowrap text-blue-600 hover:text-blue-70 focus:outline-none focus:text-blue-700 dark:text-blue-500 dark:focus:text-blue-400" href="#">
                    숙소
                </a>
            </nav>
            <div>
                <button>숙소추가하기</button>
            </div>
            <div>
